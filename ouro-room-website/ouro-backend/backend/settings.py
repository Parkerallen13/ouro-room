...
# SECRET KEY (from .env or fallback for dev)
...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'ouroroomcollective.com',
    'www.ouroroomcollective.com',
    '3.134.207.90'  # Optional, your EC2 IP
]
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",
    "http://3.134.207.90",  # Your EC2 IP
    "http://ouroroomcollective.com",
